...
export default function VouchFooter() {
  ...
  return (
    <footer className="bg-vc-surface border-t border-vc-border">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-14">
          ...
          <div>
            ...
            <p className="text-slate-600 text-sm leading-relaxed max-w-xs">
              Vouchcare is an AI powered web app that bridges gaps between patients, hospitals and
              HMO's.
            </p>
      ...
      <div className="border-t border-vc-border px-4 py-4">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-xs text-slate-400">&copy; {year} VouchCare. All rights reserved.</p>
